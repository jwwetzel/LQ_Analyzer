...
void ElectronPlots::Fill(Int_t N, Double_t pt, Double_t eta, Double_t phi, Double_t charge, Double_t trkIso, Double_t eCalIso, Double_t hCalIso, Double_t photonIso, Double_t chargedHadronIso, Double_t neutralHadronIso, Double_t dxy, Double_t dz, Double_t rho) { 
  ...
  if (pt>0.01) {
    ...
    h_Detector_RelIsorho->Fill( (ElTkIso+ElEcalIso+ElHcalIso) / pt );
  }
  else {
...
void ElectronPlots::Fill(Int_t N, Double_t pt, Double_t eta, Double_t phi, Double_t charge, Double_t trkIso, Double_t eCalIso, Double_t hCalIso, Double_t dxy, Double_t dz, Double_t rho) {
  StdPlots::Fill(1.0, N, pt, eta, phi);
  h_charge->Fill(charge);
  h_HCalIso->Fill(hCalIso);
  h_ECalIso->Fill(eCalIso);
